...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  30.12,  30.12 }
    #define DEFAULT_Ki_LIST {   2.85,   2.85 }
    #define DEFAULT_Kd_LIST { 79.70, 79.70 }
  #else
    #define DEFAULT_Kp  30.12
    #define DEFAULT_Ki   2.85
    #define DEFAULT_Kd 79.70
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 177.08
  #define DEFAULT_bedKi 33.98
  #define DEFAULT_bedKd 615.17
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -6, -2.69 }
